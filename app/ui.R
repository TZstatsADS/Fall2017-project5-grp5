                      ...
                      mainPanel(width=15,
                        ...
                        tabsetPanel(
                          ...
                          tabPanel("Daily",
                                   ...
                                   img(src="./img/24h_Records_Subscribers.png",height = 500, width = 750),
                                   hr(),
                                   h4(icon("fa fa-user-circle-o"),"Records of Customers"),
                                   img(src="./img/24h_Records_Customers.png",height = 500, width = 750))),
                      ...
                      mainPanel(width=15,
                        ...
                        tabsetPanel(
                          ...
                          tabPanel("Subscribers", 
                                   ...
                                   img(src="./img/tripduration_Subscribers.png",height = 500, width = 750)),
                          tabPanel("Customers",
                                   h3("Customers' Trip Duration Distribution of Each Month (2016):"),
                                   img(src="./img/tripduration_Customers.png",height = 500, width = 750))),
